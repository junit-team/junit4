...
public class StubbedTheoryMethodRunner extends TheoryMethodRunner {

	public StubbedTheoryMethodRunner(Method method, TestClass testClass) {
		super(method, testClass);
	}

	@Override
	protected TheoryAnchor anchor() {
		return new StubbedTheoryAnchor();
	}
