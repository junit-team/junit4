 ...
 * <ol>
 *    <li> Never-run tests first, in arbitrary order</li>
 *    <li> Group remaining tests by the date at which they most recently failed.</li>
 *    <li> Sort groups such that the most recent failure date is first, and never-failing tests are at the end.</li>
 *    <li> Within a group, run the fastest tests first.</li>
 * </ol>
 */
